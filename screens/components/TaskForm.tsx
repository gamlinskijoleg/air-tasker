...
export const TaskForm = ({ title, setTitle, price, setPrice, place, setPlace, day, setDay, timeOfDay, setTimeOfDay, jobType, setJobType, onSubmit, onCancel }: TaskFormProps) => (
